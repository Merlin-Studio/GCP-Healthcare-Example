...
```bash
export KMS_PROJECT="healthcar-sec-core-0"
export KEYRING_US_EAST1="kr-us-east1"
export LOCATION_US_EAST1="us-east1"
export KEYRING_US_WEST1="kr-us-west1"
export LOCATION_US_WEST1="us-west1"
```
...
```bash
# Get project number:
export PROJECT_NUMBER_app_dev_0=$(gcloud projects describe healthcar-app-dev-0 --format="value(projectNumber)")

# Cloud Functions source and build artifacts
gcloud kms keys add-iam-policy-binding cloudfunctions \
  --keyring=kr-us-east1 --location=us-east1 --project=$KMS_PROJECT \
...
```bash
# Get project number:
export PROJECT_NUMBER_app_prd_0=$(gcloud projects describe healthcar-app-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_app_stg_0=$(gcloud projects describe healthcar-app-stg-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_dev_0=$(gcloud projects describe healthcar-dp-dev-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_prd_0=$(gcloud projects describe healthcar-dp-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_stg_0=$(gcloud projects describe healthcar-dp-stg-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_dev_0=$(gcloud projects describe healthcar-gke-dev-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_prd_0=$(gcloud projects describe healthcar-gke-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_stg_0=$(gcloud projects describe healthcar-gke-stg-0 --format="value(projectNumber)")
